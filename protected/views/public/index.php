<div class="row">
    <div class="signIn col-md-4 col-md-offset-1">
        ...
        <?php echo $form->emailField($signUp,"email",array("class"=>"form-control signupfield","placeholder"=>"Email")) ?>
        <?php //echo $form->error($signUp,'password');?>
        <?php echo $form->passwordField($signUp,"password",array("class"=>"form-control signupfield","placeholder"=>"Password")) ?>
        <?php //echo $form->error($signUp,'repassword');?>
        <?php echo $form->passwordField($signUp,"repassword",array("class"=>"form-control signupfield","placeholder"=>"Re-type password")) ?>
