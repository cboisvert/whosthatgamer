...
class YiiMail extends CApplicationComponent
{
	...
	*/
	...
	/**
	* @var string the delivery type.  Can be either 'php','smtp' or 'postmark'.  When 
		...
		if ($this->transport===null) {
			switch ($this->transportType) {
				...
				case 'smtp':
					...
					break;
				case 'postmark':
					require_once(VENDORS_PATH.'/postmark-swiftmailer_0.0/Swift_PostmarkTransport.php');
					$this->transport = Swift_PostmarkTransport::newInstance($this->transportOptions['apiKey']);
					break;
			}
		}
    ...
    */
    public function registerScripts() {
		...
		require VENDORS_PATH."/swiftMailer_$version/classes/Swift.php";
		Yii::registerAutoloader(array('Swift','autoload'));
		require VENDORS_PATH."/swiftMailer_$version/swift_init.php";
	}
}